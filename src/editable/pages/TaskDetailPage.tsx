      ...
      <div className="mt-6 overflow-hidden rounded-2xl border border-black/10 bg-white">
        <div className="grid gap-0 sm:grid-cols-[220px_1fr]">
          <div className="relative bg-white">
            <div className="flex aspect-square w-full items-center justify-center overflow-hidden p-4 sm:aspect-auto sm:h-full">
              {portrait ? <img src={portrait} alt="" className="h-full w-full object-contain" /> : <UserRound className="h-14 w-14 text-black/40" />}
            </div>
          </div>
